...
set -o pipefail -e
export PRELAUNCH_OUT="/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/prelaunch.out"
exec >"${PRELAUNCH_OUT}"
export PRELAUNCH_ERR="/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/prelaunch.err"
...
export HADOOP_TOKEN_FILE_LOCATION="/mnt/yarn/usercache/hadoop/appcache/application_1769040496349_0001/container_1769040496349_0001_01_000002/container_tokens"
export CONTAINER_ID="container_1769040496349_0001_01_000002"
export NM_PORT="8041"
export NM_HOST="ip-172-31-41-235.ec2.internal"
...
export LOG_DIRS="/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002"
export USER="hadoop"
export LOGNAME="hadoop"
export HOME="/home/"
export PWD="/mnt/yarn/usercache/hadoop/appcache/application_1769040496349_0001/container_1769040496349_0001_01_000002"
export LOCALIZATION_COUNTERS="334824,0,2,0,317"
export JVM_PID="$$"
export NM_AUX_SERVICE_mapreduce_shuffle="AAA0+gAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="
export STDOUT_LOGFILE_ENV="/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/stdout"
...
export STDERR_LOGFILE_ENV="/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/stderr"
export HADOOP_CLIENT_OPTS=""
export MALLOC_ARENA_MAX="4"
echo "Setting up job resources"
ln -sf -- "/mnt/yarn/usercache/hadoop/appcache/application_1769040496349_0001/filecache/10/job.jar" "job.jar"
ln -sf -- "/mnt1/yarn/usercache/hadoop/appcache/application_1769040496349_0001/filecache/11/job.xml" "job.xml"
echo "Copying debugging information"
# Creating copy of launch script
cp "launch_container.sh" "/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/launch_container.sh"
chmod 640 "/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/launch_container.sh"
# Determining directory contents
echo "ls -l:" 1>"/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/directory.info"
ls -l 1>>"/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/directory.info"
echo "find -L . -maxdepth 5 -ls:" 1>>"/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/directory.info"
find -L . -maxdepth 5 -ls 1>>"/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/directory.info"
echo "broken symlinks(find -L . -maxdepth 5 -type l -ls):" 1>>"/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/directory.info"
find -L . -maxdepth 5 -type l -ls 1>>"/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/directory.info"
echo "Launching container"
exec /bin/bash -c "$JAVA_HOME/bin/java -Djava.net.preferIPv4Stack=true -Dhadoop.metrics.log.level=WARN  -Xmx2458m --add-opens=java.base/java.lang=ALL-UNNAMED --add-exports=java.base/sun.net.dns=ALL-UNNAMED --add-exports=java.base/sun.net.util=ALL-UNNAMED --add-exports=jdk.compiler/com.sun.tools.javac.util=ALL-UNNAMED --add-opens=java.base/java.io=ALL-UNNAMED --add-opens=java.base/java.lang.invoke=ALL-UNNAMED --add-opens=java.base/java.lang.reflect=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED --add-opens=java.base/java.math=ALL-UNNAMED --add-opens=java.base/java.net=ALL-UNNAMED --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/java.text=ALL-UNNAMED --add-opens=java.base/java.time=ALL-UNNAMED --add-opens=java.base/java.util.concurrent.atomic=ALL-UNNAMED --add-opens=java.base/java.util.concurrent=ALL-UNNAMED --add-opens=java.base/java.util.regex=ALL-UNNAMED --add-opens=java.base/java.util=ALL-UNNAMED --add-opens=java.base/java.util=ALL-UNNAMED --add-opens=java.base/javax.script=ALL-UNNAMED -Dillegal-access=permit --add-opens=java.base/jdk.internal.ref=ALL-UNNAMED --add-opens=java.base/jdk.internal.reflect=ALL-UNNAMED --add-opens=java.base/jdk.internal.util.random=ALL-UNNAMED --add-opens=java.base/jdk.internal.util=ALL-UNNAMED --add-opens=java.base/jdk.internal=ALL-UNNAMED --add-opens=java.base/sun.nio.ch=ALL-UNNAMED --add-opens=java.base/sun.nio.cs=ALL-UNNAMED --add-opens=java.base/sun.security.action=ALL-UNNAMED --add-opens=java.base/sun.util.calendar=ALL-UNNAMED --add-opens=java.security.jgss/sun.security.krb5=ALL-UNNAMED --add-opens=java.sql/java.sql=ALL-UNNAMED --add-opens=jdk.management/com.sun.management.internal=ALL-UNNAMED -Djava.io.tmpdir=$PWD/tmp -Dlog4j.configuration=container-log4j.properties -Dyarn.app.container.log.dir=/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002 -Dyarn.app.container.log.filesize=0 -Dhadoop.root.logger=INFO,CLA -Dhadoop.root.logfile=syslog org.apache.hadoop.mapred.YarnChild 172.31.43.87 42613 attempt_1769040496349_0001_m_000000_0 2 1>/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/stdout 2>/var/log/hadoop-yarn/containers/application_1769040496349_0001/container_1769040496349_0001_01_000002/stderr "
